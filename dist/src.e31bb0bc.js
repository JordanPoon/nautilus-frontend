...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"AlertAPI.js":[function(require,module,exports) {
"use strict";
...
class AlertAPI {
  async newAlert(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/alert"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _AlertAPI = _interopRequireDefault(require("./../../AlertAPI"));
...
class HomeView {
  ...
  async getAlerts() {
    try {
      this.alerts = await _AlertAPI.default.getAlerts();
  ...
  moreInfoHandler() {
    ...
    const sensorDialogContent = (0, _litHtml.html)(_templateObject());
    (0, _litHtml.render)(sensorDialogContent, sensorDialog); // append to ducment.body

    document.body.append(sensorDialog); //show sl-dialog

    sensorDialog.show(); // on hide delete
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2(), JSON.stringify(_Auth.default.currentUser), this.moreInfoHandler.bind(this), this.moreInfoHandler.bind(this), this.moreInfoHandler.bind(this), this.moreInfoHandler.bind(this), this.moreInfoHandler.bind(this), this.alerts == null ? (0, _litHtml.html)(_templateObject3()) : (0, _litHtml.html)(_templateObject4(), this.alerts.map(alert => (0, _litHtml.html)(_templateObject5(), alert.icon, alert.type, (0, _moment.default)(alert.createdAt).format('MMMM Do YYYY, @ h:mm a'), alert.description))));
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../AlertAPI":"AlertAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
class UserAPI {
  ...
  async getUser(userId) {
    ...
    if (!response.ok) {
      // console log error
      const err = await response.json();
      if (err) console.log(err); // throw error (exit this funtion)
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n              <sl-avatar shape=\"rounded\" style=\"--size: 100px; margin: 1em 1em 1em 0em;\" image=\"", "/images/", "\"></sl-avatar>\n              <input type=\"file\" name=\"avatar\" />\n            "]);
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5()), this.user.firstName, this.user.lastName, this.user.email, (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a')));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/vessels.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Vessels\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">  \n\n        <div class=\"haircuts-grid\">\n        ", "\n        </div> \n\n      </div>      \n    "]);
...
class VesselsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.vessels == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.vessels.map(vessel => (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, vessel.image, vessel.name, vessel.name))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new VesselsView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../Toast":"Toast.js"}],"HaircutAPI.js":[function(require,module,exports) {
"use strict";
...
class HaircutsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.haircuts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.haircuts.map(haircut => (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, haircut.image, haircut.name, haircut.name, haircut.price, haircut.description, haircut.user.firstName, haircut.user.lastName))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/alerts.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Alerts\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">  \n\n      <div class=\"alerts-grid\">\n      ", "\n      </div>\n\n      </div>      \n    "]);
...
class AlertsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.alerts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.alerts.map(alert => (0, _litHtml.html)(_templateObject4(), alert.icon, alert.type, (0, _moment.default)(alert.createdAt).format('MMMM Do YYYY, @ h:mm a'), alert.description))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new AlertsView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../AlertAPI":"AlertAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/guide.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/newHaircut.js":[function(require,module,exports) {
"use strict";
...
class newHaircutView {
  ...
  async newHaircutSubmitHandler(e) {
    ...
    try {
      ...
      const radioInputs = document.querySelectorAll('sl-input, sl-textarea');
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/admin.js":[function(require,module,exports) {
"use strict";
...
class newAlertView {
  ...
  async newAlertSubmitHandler(e) {
    ...
    try {
      await _AlertAPI.default.newAlert(formData);

      _Toast.default.show('Alert added!');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newAlertSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newAlertView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../AlertAPI":"AlertAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _vessels = _interopRequireDefault(require("./views/pages/vessels"));

var _haircuts = _interopRequireDefault(require("./views/pages/haircuts"));

var _alerts = _interopRequireDefault(require("./views/pages/alerts"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/vessels":"views/pages/vessels.js","./views/pages/haircuts":"views/pages/haircuts.js","./views/pages/alerts":"views/pages/alerts.js","./views/pages/guide":"views/pages/guide.js","./views/pages/newHaircut":"views/pages/newHaircut.js","./views/pages/admin":"views/pages/admin.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-haircut', class Haircut extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), this.image, this.name, this.name, this.description, this.price, this.gender, this.length);
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), this.image, this.name, this.price, this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/sensor-tile.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-sensor', class Sensor extends _litElement.LitElement {
  constructor() {
    super();
  }
...
require("./components/sensor-tile");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-haircut":"components/va-haircut.js","./components/sensor-tile":"components/sensor-tile.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
